...
int main(int argc, char *argv[])
{
  ...
  qmlRegisterType<MapQuickView>("Esri.TestFutureLifetime", 1, 0, "MapView");

  // Register the TestFutureLifetime (QQuickItem) for QML
  qmlRegisterType<TestFutureLifetime>("Esri.TestFutureLifetime", 1, 0, "TestFutureLifetime");
